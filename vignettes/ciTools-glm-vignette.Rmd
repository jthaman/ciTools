...
```{r fig.heither = 7, fig.align = "center"}
...
`add_pi()`, we also estimate quantiles and probabilities using the
...
probabilities are generally close to the nomial level. Interval widths
